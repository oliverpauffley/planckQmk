...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, _______, KC_LCBR, KC_LBRC, KC_LPRN,  KC_GRV, KC_QUOT, KC_RPRN, KC_RBRC, KC_RCBR, _______, KC_PIPE,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______,    KC_4,    KC_5,    KC_6, KC_PPLS,  KC_ENT,
